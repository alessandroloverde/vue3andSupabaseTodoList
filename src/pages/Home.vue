   ...
   <div v-if="!isLoggedIn()" class="homePage">
      <div class="WTK-wrapper--medium introBkg">
         <div class="WTK-row--jCenter">
            <section class="homePage--intro WTK-col-10 WTK-col-laptop-8 WTK-col-desktop-6">
               <div class="homePage--intro--heading WTK-row--jCenter">
                  <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                       ...
                       x="0px" y="0px" viewBox="0 0 750 106"
                       style="enable-background:new 0 0 750 106;" 
                       xml:space="preserve" 
			...
			c-2.7,0-4.7,0.8-5.8,2.3s-1.7,3.2-1.7,5v31.2c0,1.8,0.6,3.4,1.7,5c1.1,1.6,3.1,2.3,5.8,2.3H226.2z" class="svg-elem-2"></path>
			...
			s6.1,1.8,6.1,5.3V85c0,3.5-2,5.3-6.1,5.3c-1.6,0-3-0.3-4.2-0.8c-1.3-0.6-1.9-1.8-1.9-3.7V33.4z"
                              class="svg-elem-4"></path>
                           <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);"
                           d="M414.3,71.9c0,1.8,0.6,3.4,1.7,5s3.1,2.3,5.8,2.3h13.9c2.7,0,4.7-0.7,5.8-2.1c1.1-1.4,1.7-2.9,1.7-4.7v-1.2
			...
			c0,1.5-0.3,2.7-1,3.7s-1.7,1.5-3.1,1.5h-14.4V89.7z" class="svg-elem-8"></path>
                           <path fill="#ff6262" stroke="#ff6262"
                           d="M663.3,50.9c1.8,0,3.8,0.4,5.9,1.3c2.1,0.9,4.1,1.9,5.9,3.2H675c1.9,1.4,3.4,3.2,4.4,5.4c1,2.2,1.6,4.9,1.6,8
		...
		z" class="svg-elem-14"></path>
                  ...
                  <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                     ...
                     <g id="Glaim-group">
                        ...
                        <path id="L-2-2" data-name="L-2" d="M471,123.79v-5.6l5-1V77.23l-5.36-1V70.58h14.64v46.59l5,1v5.6Z"
                           fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-27"></path>
