<template>
   <div v-if="!isLoggedIn()" class="homePage">
      <div class="introBkg ⭐-Wrapper">
         <section class="homePage--intro ⭐-Row">
            <div class="homePage--intro--heading ⭐-Col--centered ⭐-col-8">
               <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  id="WondertaskLogo" class="homePage--intro--heading--logo" x="0px" y="0px" viewBox="0 0 750 106"
                  style="enable-background:new 0 0 750 106;" xml:space="preserve" width="100%" height="auto">
                  <g id="NAME">
                     <g class="st0">
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M134.2,86.2l0.1-0.1c-0.5,1.7-1.5,2.8-3,3.3s-3,0.8-4.4,0.8s-2.9-0.3-4.4-0.8s-2.5-1.6-2.9-3.3l0.1,0.1
      l-14.5-57.4c-0.9-3.1,0.6-5.2,4.3-6.2c3.6-1,5.9,0.3,7,3.8v-0.1l9,36.1h3l9-36.1c0.4-1.6,1.2-2.6,2.5-3c1.3-0.5,2.5-0.7,3.6-0.7
      c1.3,0,2.5,0.3,3.7,0.8s2.1,1.5,2.5,2.9c0.7,2.7,1.3,5.1,1.8,7.4c0.6,2.3,1.1,4.5,1.6,6.7c0.5,2.1,1,4.2,1.5,6.3
      c0.5,2.1,1,4.2,1.6,6.4l2.4,9.4h3c1.5-6,3-12,4.5-18.1s3-12.1,4.5-18.1l-0.1,0.1c1-3.5,3.4-4.7,7-3.8c3.8,0.9,5.2,3,4.3,6.2
      l-14.4,57.4l0.1-0.1c-0.4,1.7-1.4,2.8-2.9,3.3s-3,0.8-4.5,0.8c-1.4,0-2.8-0.3-4.3-0.8s-2.5-1.6-3-3.3l0.1,0.1l-7.9-31.1h-3
      L134.2,86.2z" class="svg-elem-1"></path>
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M228.2,22.9c1.9,0,3.9,0.4,5.9,1.2s4,1.8,5.9,3.1h-0.1c1.9,1.4,3.4,3.2,4.4,5.5s1.6,4.9,1.6,7.8V72
      c0,6.1-2,10.5-6,13.4c-3.9,2.8-7.8,4.2-11.8,4.2h-17.7c-1.9,0-3.9-0.3-5.9-1s-4-1.7-5.9-3.2c-4-2.8-6-7.3-6-13.4V40.6
      c0-3,0.5-5.6,1.6-7.8c1-2.3,2.5-4.1,4.4-5.5h-0.1c1.8-1.3,3.8-2.3,5.9-3.1c2.1-0.8,4.1-1.2,6-1.2L228.2,22.9L228.2,22.9z
         M226.2,79.2c2.7,0,4.7-0.8,5.8-2.3c1.1-1.6,1.7-3.2,1.7-5V40.7c0-1.8-0.6-3.5-1.7-5s-3.1-2.3-5.8-2.3h-13.7
      c-2.7,0-4.7,0.8-5.8,2.3s-1.7,3.2-1.7,5v31.2c0,1.8,0.6,3.4,1.7,5c1.1,1.6,3.1,2.3,5.8,2.3H226.2z" class="svg-elem-2">
                        </path>
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M274.3,85c0,3.5-2,5.3-6.1,5.3s-6.1-1.8-6.1-5.3V40.5c0-3,0.5-5.7,1.4-7.9c1-2.2,2.5-4,4.5-5.4
      c3.9-2.8,7.8-4.2,11.8-4.2h17.8c3.8,0,7.7,1.4,11.8,4.2c4,2.8,6,7.2,6,13.3v44.6c0,3.5-2,5.3-6.1,5.3s-6.1-1.8-6.1-5.3V41.5
      c0-1.9-0.6-3.8-1.8-5.5l0.1,0.1c-1-1.8-2.9-2.7-5.9-2.7h-13.8c-3,0-5,0.9-6,2.7c-1,1.6-1.6,3.4-1.6,5.4V85H274.3z"
                           class="svg-elem-3"></path>
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M373.1,33.4h-21.4c-3,0-5,0.9-6,2.7c-1,1.6-1.6,3.4-1.6,5.4v31.9c0,1.9,0.6,3.4,1.8,4.4
      c1.2,1,3.1,1.5,5.9,1.5h11.4c2.7,0,4,1.7,4,5.2c0,1.5-0.3,2.7-0.9,3.7s-1.6,1.5-3,1.5h-13.5c-4.7,0-8.8-1.2-12.4-3.5
      c-3.6-2.2-5.4-6.4-5.4-12.6v-33c0-3,0.5-5.7,1.4-7.9c1-2.2,2.5-4,4.5-5.4c3.9-2.8,7.8-4.2,11.8-4.2h23.4V6.3c0-3.5,2-5.3,6.1-5.3
      s6.1,1.8,6.1,5.3V85c0,3.5-2,5.3-6.1,5.3c-1.6,0-3-0.3-4.2-0.8c-1.3-0.6-1.9-1.8-1.9-3.7V33.4z" class="svg-elem-4">
                        </path>
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M414.3,71.9c0,1.8,0.6,3.4,1.7,5s3.1,2.3,5.8,2.3h13.9c2.7,0,4.7-0.7,5.8-2.1c1.1-1.4,1.7-2.9,1.7-4.7v-1.2
      c0-3.5,2-5.2,6.1-5.2s6.1,1.7,6.1,5.2v1.3c0,3.1-0.5,5.7-1.5,7.6c-1,2-2.5,3.7-4.5,5.2c-3.9,2.8-7.8,4.2-11.8,4.2H419
      c-3.9,0-7.7-1.4-11.4-4.2c-1.8-1.5-3.1-3.3-4.1-5.6c-1-2.3-1.4-4.9-1.4-7.8V40.5c0-6,1.8-10.4,5.5-13.3c1.8-1.3,3.7-2.4,5.7-3.2
      s3.9-1.2,5.7-1.2h18.6c1.8,0,3.7,0.4,5.9,1.1c2.1,0.7,4.1,1.6,6,2.8c1.8,1.3,3.2,3,4.3,5.2c1.1,2.2,1.6,4.8,1.6,7.9v15
      c0,1.7-0.5,3.2-1.5,4.5s-2.8,2-5.5,2h-23.9c-2.7,0-4.1-1.7-4.2-5.2c0-3.5,1.4-5.2,4.2-5.2h18.8l-0.1-10.3c0-1.8-0.6-3.5-1.7-5
      s-3.1-2.3-5.8-2.3h-13.9c-2.7,0-4.7,0.8-5.8,2.3c-1.1,1.5-1.7,3.2-1.7,5V71.9z" class="svg-elem-5"></path>
                        <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M483.7,85c0,3.5-2,5.3-6.1,5.3c-4.2,0-6.3-1.8-6.3-5.3V39.1c0-6.1,1.8-10.3,5.4-12.6
      c3.6-2.4,7.8-3.5,12.5-3.5h12.6c2.7,0,4.1,1.7,4.1,5.2c0.1,3.5-1.2,5.2-4.1,5.2H490c-2.7,0-4.4,0.5-5.2,1.6
      c-0.8,1-1.2,2.5-1.2,4.3V85H483.7z" class="svg-elem-6"></path>
                     </g>
                     <g class="st0">
                        <path fill="#ff6262;" stroke="#ff6262;" d="M532.1,33.4v40.3c0,1.9,0.4,3.4,1.2,4.4s2.5,1.6,5.2,1.6h2.9c2.9,0,4.2,1.7,4.1,5.1c0,3.5-1.4,5.2-4.1,5.2
      h-3.6c-2.4,0-4.6-0.3-6.7-0.9c-2.1-0.6-4.1-1.5-6-2.7v0.1c-3.6-2.4-5.4-6.6-5.4-12.6V33.4h-4.3c-2.7,0-4.1-1.7-4.2-5.2
      c0-3.5,1.4-5.2,4.2-5.2h4.3V11.1c0-3.5,2.1-5.3,6.3-5.3c4.1,0,6.1,1.8,6.1,5.3v11.8h9.2c2.9,0,4.2,1.7,4.1,5.2
      c0,3.5-1.4,5.2-4.1,5.2L532.1,33.4L532.1,33.4z" class="svg-elem-7"></path>
                        <path fill="#ff6262;" stroke="#ff6262" d="M574.2,89.7c-2.3,0-4.5-0.3-6.5-0.9c-2.1-0.6-4.1-1.5-6-2.7v0.1c-3.6-2.3-5.4-6.5-5.4-12.6v-5.4
      c0-3,0.5-5.7,1.6-7.9c1.1-2.3,2.6-4,4.5-5.4h-0.1c1.8-1.3,3.8-2.2,5.9-2.8c2.1-0.6,4.1-0.9,6-0.9h24.5V40.7c0-1.8-0.6-3.5-1.7-5
      ...
      v-1c0-3,0.5-5.6,1.6-7.6c1.1-2.1,2.5-3.8,4.4-5.2h-0.1c1.9-1.3,3.9-2.3,6-3.1s4.1-1.2,6-1.2h16.8c1.8,0,3.8,0.4,5.9,1.2
      c2.1,0.8,4.1,1.8,5.9,3.1h-0.1c1.9,1.4,3.4,3.2,4.4,5.5s1.6,4.9,1.6,7.8v44.5c0,3.5-2,5.3-6.1,5.3c-0.8,0-1.6,0-2.3-0.1
      s-1.3-0.3-1.9-0.6c-0.6-0.3-1-0.8-1.3-1.4s-0.5-1.5-0.5-2.5l-0.1-24.3h-22.4c-1.6,0-2.9,0.2-3.8,0.6c-0.9,0.4-1.6,1-2.1,1.8
      c-0.6,1.3-1,2.2-1.3,2.9c-0.3,0.7-0.4,1.5-0.4,2.4v4.3c0,1.9,0.6,3.4,1.7,4.4c1.1,1,3.1,1.5,5.9,1.5h12.4c2.7,0,4.1,1.7,4.1,5.2
      c0,1.5-0.3,2.7-1,3.7s-1.7,1.5-3.1,1.5h-14.4V89.7z" class="svg-elem-8"></path>
                        <path fill="#ff6262" stroke="#ff6262" d="M663.3,50.9c1.8,0,3.8,0.4,5.9,1.3c2.1,0.9,4.1,1.9,5.9,3.2H675c1.9,1.4,3.4,3.2,4.4,5.4c1,2.2,1.6,4.9,1.6,8
      ...
      v-1.3c0-3.2,2-4.7,6.1-4.7s6.2,1.6,6.2,4.7v1.1c0,1.8,0.6,3.4,1.7,5s3.1,2.3,5.9,2.3h14.6c2.8,0,4.8-0.8,5.9-2.3s1.7-3.2,1.7-5
      v-3.1c0-1-0.1-1.9-0.4-2.8c-0.3-0.9-0.7-1.7-1.3-2.4c-0.6-0.7-1.4-1.3-2.3-1.7c-1-0.4-2.1-0.7-3.5-0.7H645c-3.8,0-7.7-1.3-11.9-4
      c-3.9-2.5-5.9-6.8-5.9-13v-3.8c0-3,0.5-5.6,1.6-7.8c1-2.3,2.5-4.1,4.4-5.5h-0.1c1.8-1.3,3.8-2.3,5.9-3.1c2.1-0.8,4.1-1.2,6-1.2
      h17.7c1.9,0,3.9,0.4,5.9,1.2s4,1.8,5.9,3.1h-0.1c1.9,1.4,3.4,3.2,4.4,5.5s1.6,4.9,1.6,7.8v1c0,1.6-0.5,2.7-1.6,3.4
      c-1,0.7-2.5,1.1-4.5,1.2c-4.1,0.1-6.1-1.4-6.1-4.5v-0.9c0-1.8-0.6-3.5-1.7-5c-1.1-1.5-3.1-2.3-5.8-2.3H647c-2.7,0-4.7,0.8-5.8,2.3
      s-1.7,3.2-1.7,5v2.7c0,1.9,0.6,3.7,1.7,5.2c1.1,1.6,3.1,2.3,5.8,2.3h16.3V50.9z" class="svg-elem-9"></path>
                        <path fill="#ff6262" stroke="#ff6262" d="M709.8,71.2v14.1c0,3.5-2,5.2-6.1,5.2s-6.1-1.7-6.1-5.2v-79c0-3.5,2-5.3,6.1-5.3s6.1,1.8,6.1,5.3v47
      c1.8-2.2,3.9-4.6,6.2-7.1s4.5-5.1,6.8-7.8c2.3-2.6,4.5-5.2,6.7-7.8c2.2-2.5,4.3-4.9,6.2-7.2v0.1c1.3-1.6,2.7-2.3,4-2.3
      c0.7,0,1.5,0.2,2.2,0.5s1.5,0.8,2.3,1.4h-0.1c1.8,1.5,2.7,3,2.7,4.4c0,0.5-0.1,1.1-0.3,1.7c-0.2,0.6-0.6,1.2-1.1,1.6L709.8,71.2z
         M746.9,82.2c0.5,1,0.8,2,0.8,3c0,1.9-1.1,3.4-3.3,4.3c-1.5,0.9-2.8,1.3-4,1.3c-0.8,0-1.6-0.3-2.3-0.8c-0.7-0.6-1.3-1.2-1.8-2.1
      l-11.1-21.4c-0.7-1.1-1-2.2-1-3.3c0-1.8,1-3.4,2.9-4.7c0.5-0.4,1.1-0.7,1.6-1c0.6-0.3,1.2-0.5,1.8-0.7c0.8-0.1,1.6,0,2.3,0.4
      s1.4,1,1.9,1.8L746.9,82.2z" class="svg-elem-10"></path>
                     </g>
                  </g>
                  <g id="ICON">
                     <path fill="#ff6262" stroke="#ff6262" d="M80.1,50.9c0,13.1,0,26.2,0,39.3c0,6.8-4.3,11.1-11.1,11.1H11.2c-6.3,0-10.7-4.4-10.7-10.8
   c0-26.3,0-52.5,0-78.8c0-6.4,4.4-11.1,10.9-11.1c19.3-0.1,38.7-0.1,58,0c6-0.1,10.8,4.7,10.9,10.7c0,0.1,0,0.2,0,0.4
   C79.9,24.7,80.1,37.8,80.1,50.9z M40.1,26.2c-5.3,0-10.7,0-16.1,0c-2.8,0-4.5,1.3-4.7,3.4c-0.2,2.5,1.5,4.2,4.5,4.2
   c10.8,0,21.6,0,32.3,0c0.7,0.1,1.5-0.1,2.1-0.5c1-0.9,1.8-2,2.3-3.2c0.4-1.5-0.6-3.1-2.1-3.5c-1-0.3-2-0.5-3-0.5
   C50.4,26.2,45.3,26.2,40.1,26.2z M40.2,47.2H24c-2.9,0-4.5,1.3-4.6,3.7s1.4,3.8,4.4,3.8c10.9,0,21.7,0,32.6,0
   c2.9,0,4.3-1.3,4.4-3.6s-1.6-3.8-4.4-3.8C51,47.2,45.6,47.2,40.2,47.2z M40,75.1L40,75.1c5.5,0,11,0,16.5,0c2.8,0,4.3-1.4,4.2-3.8
   s-1.6-3.6-4.4-3.6c-10.8,0-21.7,0-32.5,0c-0.3,0-0.6,0-0.9,0c-2,0-3.6,1.7-3.6,3.7c0,0,0,0,0,0.1c-0.1,1.8,1.3,3.4,3.1,3.5
   c0.1,0,0.2,0,0.4,0C28.6,75.1,34.3,75.1,40,75.1z" class="svg-elem-11"></path>
                     <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);"
                        d="M40.1,26.2c5.1,0,10.3,0,15.4,0c1,0,2,0.2,3,0.5c1.5,0.4,2.5,2,2.1,3.5c-0.5,1.2-1.3,2.3-2.3,3.2
                     c-0.6,0.4-1.4,0.6-2.1,0.5c-10.8,0-21.6,0-32.3,0c-3.1,0-4.8-1.7-4.5-4.3c0.2-2.1,1.9-3.4,4.7-3.4C29.4,26.2,34.8,26.2,40.1,26.2z" class="svg-elem-12"></path>
                     <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M40.2,47.2c5.3,0,10.7,0,16.1,0c2.9,0,4.5,1.4,4.4,3.8s-1.4,3.6-4.4,3.6c-10.8,0-21.7,0-32.5,0
                     c-3,0-4.5-1.3-4.5-3.8s1.7-3.7,4.6-3.7L40.2,47.2z" class="svg-elem-13"></path>
                     <path fill="rgb(255, 255, 255);" stroke="rgb(255, 255, 255);" d="M40,75.1c-5.7,0-11.5,0.1-17.2,0c-1.8,0.1-3.4-1.3-3.5-3.2c0-0.1,0-0.2,0-0.4c-0.1-2,1.5-3.7,3.5-3.8
   c0,0,0,0,0.1,0c0.3,0,0.6,0,0.9,0c10.9,0,21.7,0,32.5,0c2.8,0,4.3,1.3,4.4,3.6s-1.4,3.7-4.2,3.8C51,75.2,45.5,75.1,40,75.1L40,75.1
   z" class="svg-elem-14"></path>
                  </g>
               </svg>
               <svg version="1.1" xmlns="http://www.w3.org/2000/svg" id="Claim"
                  class="homePage--intro--heading--claim" viewBox="0 0 598 146">
                  <g id="Glaim-group">
                     <path id="C-1-2" data-name="C-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-1"></path>
                     <path id="O-1-2" data-name="O-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-2"></path>
                     <path id="L-1-2" data-name="L-1" d="M90,60.25v-5.6l5-1V13.69l-5.36-1V7H104.2V53.63l5,1v5.6Z"
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-3"></path>
                     <path id="O-2-2" data-name="O-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-4"></path>
                     <path id="R-1-2" data-name="R-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-5"></path>
                     <path id="Y-1-2" data-name="Y-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-6"></path>
                     <path id="O-3-2" data-name="O-3"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-7"></path>
                     <path id="U-1-2" data-name="U-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-8"></path>
                     <path id="R-2-2" data-name="R-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-9"></path>
                     <path id="T-1-2" data-name="T-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-10"></path>
                     <path id="A-1-2" data-name="A-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-11"></path>
                     <path id="S-1-2" data-name="S-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-12"></path>
                     <polygon
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-13"></polygon>
                     <path id="S-2-2" data-name="S-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-14"></path>
                     <path id="Comma-2" data-name="Comma"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-15"></path>
                     <path id="S-3-2" data-name="S-3"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-16"></path>
                     <path id="P-1-2" data-name="P-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-17"></path>
                     <path id="I-1-2" data-name="I-1"
                        d="M83.53,123.79v-5.6l5-1V93.53l-5.36-1V86.88H97.76v30.29l4.94,1v5.6Zm4.61-45V70.58h9.62V78.8Z"
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-18"></path>
                     <path id="C-2-2" data-name="C-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-19"></path>
                     <path id="E-1-2" data-name="E-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-20"></path>
                     <path id="U-2-2" data-name="U-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-21"></path>
                     <path id="P-2-2" data-name="P-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-22"></path>
                     <path id="Y-2-2" data-name="Y-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-23"></path>
                     <path id="O-4-2" data-name="O-4"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-24"></path>
                     <path id="U-3-2" data-name="U-3"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-25"></path>
                     <path id="R-3-2" data-name="R-3"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-26"></path>
                     <path id="L-2-2" data-name="L-2"
                        d="M471,123.79v-5.6l5-1V77.23l-5.36-1V70.58h14.64v46.59l5,1v5.6Z" fill="#0071bc"
                        stroke="#fff" stroke-miterlimit="10" class="svg-claim-27"></path>
                     <path id="I-2-2" data-name="I-2"
                        d="M493.54,123.79v-5.6l4.95-1V93.53l-5.36-1V86.88h14.63v30.29l5,1v5.6Zm4.6-45V70.58h9.62V78.8Z"
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-28"></path>
                     <path id="F-1-2" data-name="F-1"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-29"></path>
                     <path id="E-2-2" data-name="E-2"
                        ...
                        fill="#0071bc" stroke="#fff" stroke-miterlimit="10" class="svg-claim-30"></path>
                     <path id="Exclamation-2" data-name="Exclamation"
                        d="M581.57,106.83V74.12h9.28v32.71Zm0,17v-8.36h9.28v8.36Z" fill="#0071bc" stroke="#fff"
                        stroke-miterlimit="10" class="svg-claim-31"></path>
                  </g>
               </svg>
            </div>
      ...
      <section id="tempNewPage" class="homePage--temp">
         <div class="⭐-Wrapper">
            <div class="⭐-Row">
               <h1 class="⭐-Col ⭐-col-12">Why Wondertask?</h1>
               <div class="⭐-Col ⭐-col-4 ⭐-col-6--laptop">
                  <div class="hexagon-1">
                     ...
                     <article>
                        ...
                        <h3>Is simple...</h3>
                        <h6>off with apps packed with tons of stuff you’ll never use<span class="additionalText">: Wondertask goes straight to the point</span></h6>
                     </article>
                  </div>
               </div>
               <div class="⭐-Col ⭐-col-4 ⭐-col-6--laptop">
                  <div class="hexagon-2">
                     ...
                     <article>
                        ...
                        <h3>...but powerful</h3>
                        <h6>get your task done, hide them as completed, sort them in categories<span class="additionalText">: you've everthing you need</span></h6>
                     </article>
                  </div>
               </div>
               <div class="⭐-Col ⭐-col-4 ⭐-col-6--laptop">
                  <div class="hexagon-3">
                     ...
                     <article>
                        ...
                        <h3>...and flexible!</h3>
                        <h6>assign a category its own color or a meaningful icon, or both<span class="additionalText"> if that fits you.</span></h6>
                     </article>
                  </div>
               </div>
            </div>
         </div>
         <div class="" id="wave"></div> <!-- *** Waves background *** -->
      </section>
      ...
      <section class="homePage--cta">
         ...
         <div class="⭐-Wrapper">
            <div class="⭐-Row">
               <h2 class="">Possible headline</h2>

               <div class="card ⭐-Col--centered ⭐-Col ⭐-col-8 ⭐-col-10--desktop ⭐-col-12--laptop"> <!-- *** Card 1 *** -->
                  <div class="card--bkg">
                     <div class="⭐-Row">
                        <div class="card--content ⭐-Col--centered ⭐-col-8">
                        ...
                        <div class="card--image ⭐-Col ⭐-col-4">
               ...
               <div class="card ⭐-Col--centered ⭐-Col ⭐-col-8 ⭐-col-10--desktop ⭐-col-12--laptop"> <!-- *** Card 2 *** -->
                  <div class="card--bkg">
                     <div class="⭐-Row">
                        <div class="card--image ⭐-Col ⭐-col-4">
                        ...
                        <div class="card--content ⭐-Col ⭐-col-8">
                           <svg xmlns="http://www.w3.org/2000/svg" id="multicolor-toDolist-icon" class="card--icon"
                              data-name="Layer 1" viewBox="0 0 24 24" width="512" height="512">
                              <defs>
                                 <linearGradient id="grad-1" x1="0%" x2="100%" y1="0%" y2="0%">
                           ...
                           <hr class="card--divider">
                           <p class="card--description">Wondertask's intuitive design makes it simple to manage your
                              tasks, helping you stay focused and productive.</p>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div v-else class="todoListApp">
      <CategoriesArea :categories="categories" :tasks="tasks" @categoryUpdated="onFetch('categories')"></CategoriesArea>
      <TasksArea :categories="categories" :tasks="tasks" :index="0" @taskUpdated="onFetch('tasks')"></TasksArea>
   </div>
</template>
