<template>
   <div v-if="!isLoggedIn()" class="homePage debug">
      ...
      <section id="tempNewPage" class="homePage--temp">
         <div class="W-Wrapper">
            <div class="">
               <h1 class=""><i class="fi fi-rr-camera"></i>Why Wondertask?</h1>
               <div class="">
                  <div class="hexagon-1">
               ...
               <div class="">
                  ...
                  <div class="">
                     <div id="toBeDefined">
                        ...
                        <p>Wondertask doesn't save your tasks in your browser but in a Supabase database so… well,
                           you need to register.</p>
                        <p>But there's good news also; you have your taks wherever you want. Youst login and
                           you're up to go!</p>
                     </div>
                  </div>
                  <div class="">
   ...
   <div v-else class="todoListApp">
      <CategoriesArea :categories="categories" :tasks="tasks" @categoryUpdated="onFetch('categories')">
      </CategoriesArea>
      <TasksArea :categories="categories" :tasks="tasks" :index="0" @taskUpdated="onFetch('tasks')">
      </TasksArea>
   </div>
</template>
